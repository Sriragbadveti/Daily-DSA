<h2><a href="https://leetcode.com/problems/minimum-flips-to-make-binary-string-coherent/description/">3922. Minimum Flips to Make Binary String Coherent</a></h2><h3>Medium</h3><hr><p>You are given a binary string <code>s</code>.</p>
